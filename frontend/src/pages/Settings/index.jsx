...
export default function Settings() {
  return (
    <>
      ...
      <div className="mb-8 overflow-hidden rounded-2xl border border-neutral-800 bg-neutral-900/40">
        <div className="flex items-center justify-between gap-4 border-b border-neutral-800/80 px-6 py-4">
          <div>
            <h2 className="text-sm font-semibold text-neutral-100">Surfboard Payments</h2>
        ...
        <div className="grid grid-cols-1 gap-6 px-6 py-5 sm:grid-cols-3">
          <div>
            ...
            <p className="mt-1 text-sm font-medium text-neutral-100">Configured</p>
          </div>
          <div>
          ...
          <div>
            ...
            <p className="mt-1 flex items-center gap-1.5 text-sm font-medium text-neutral-100">
        ...
        <div className="border-t border-neutral-800/80 px-6 py-5">
        ...
        <div className="border-t border-neutral-800/80 px-6 py-3.5">
          <Link
